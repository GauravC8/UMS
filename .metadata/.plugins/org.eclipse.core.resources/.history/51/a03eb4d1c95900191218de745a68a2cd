					...
					<div class="banner-text text-center">
						...
						<div class="intro-para text-center quote">
							<p class="big-text">Follow your dreams, &nbsp they know the
								way.
							<p>
							<p class="small-text">Jubilant sets the benchmark of the
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="images/library.jfif" class="img-responsive">
						<figcaption>
							<h3>Library</h3>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="images/classroom.jfif" class="img-responsive">
						<figcaption>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="images/auditorium.jfif" class="img-responsive">
						<figcaption>
							<h3>Auditorium</h3>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="images/play.jfif" class="img-responsive">
						<figcaption>
							<h3>Playground</h3>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="images/hostel.jfif" class="img-responsive">
						<figcaption>
				...
				<div class="col-md-4 col-sm-6 padleft-right">
					<figure class="imghvr-fold-up">
						<img src="images/labs.jfif" class="img-responsive">
						<figcaption>
							<h3>Laboratory</h3>
